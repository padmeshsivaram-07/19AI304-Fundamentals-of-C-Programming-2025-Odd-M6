...
```
# Output:
![alt text](<Screenshot 2025-12-27 072129.png>)
# Result: 
...
```
# Output:
![alt text](<Screenshot 2025-12-27 072237.png>)
# Result: 
Thus, the program was implemented and executed successfully, and the required output was obtained.
...
int main() {
    ...
    for (i = 0; i < n; i++) {
        printf("Enter employee number, name (no spaces), and salary: ");
        scanf("%d %s %f", &emp[i].eno, emp[i].ename, &emp[i].salary);
    }
...
```
# Output:
![alt text](<Screenshot 2025-12-27 072455.png>)
...
```
# Output:
![alt text](<Screenshot 2025-12-27 073152.png>)
...
```
# Output:
![alt text](<Screenshot 2025-12-27 073218.png>)
# Result: 
Thus, the program was implemented and executed successfully, and the required output was obtained.
